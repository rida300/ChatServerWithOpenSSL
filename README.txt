...
To add the ability to remove a chat room, i used a signal handler, however, as of now, a server can only exit if it has just been started. I was implementing SSL_pending to check for a signal at all times but ran out of time. Running CTRL C will remove the chatroom. Confirmation: add a chat room with the same name and it will be added as no duplicates are allowed. 
CIS 525 Project 3
Sources:
1. https://www.hackanons.com/2018/09/full-duplex-encrypted-chat-server-using.html
2. https://www.openssl.org/docs/man1.0.2/man3/SSL_read.html
